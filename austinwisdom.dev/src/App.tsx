import './App.css'
import logoImage from './assets/images/logo/aw.svg'
...
function App() {
  ...
  root.addEventListener('mousemove', (e) => {
    const x = e.clientX,
    y = e.clientY;
    background.style.transform = `translate(${-x / 80}px,${-y / 80}px)`;
  });
  ...
  <div className='w-screen h-screen flex'>
    <section>
      <img className='animate-pulse mt-20 ml-20 w-full' src={logoImage} />
    </section>
      <section id='module' className='flex animate-none justify-center sm:justify-end'>
        <div className='my-96 sm:mx-40 sm:my-40 animate-none'>
          ...
          <h1 className='text-red-100 animate-none text-6xl hover:cursor-default transition hover:text-white'>Educator,</h1>
          <h1 className='text-red-100 animate-none text-6xl hover:cursor-default transition hover:text-white'>Software Engineer</h1>
